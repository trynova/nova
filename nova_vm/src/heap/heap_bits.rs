...
pub(crate) struct WorkQueues {
    ...
    pub declarative_environments: Vec<DeclarativeEnvironmentIndex<'static>>,
    ...
    pub function_environments: Vec<FunctionEnvironmentIndex<'static>>,
    pub generators: Vec<Generator<'static>>,
    pub global_environments: Vec<GlobalEnvironmentIndex<'static>>,
    ...
    pub object_environments: Vec<ObjectEnvironmentIndex<'static>>,
