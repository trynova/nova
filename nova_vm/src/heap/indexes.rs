...
#[cfg(feature = "array-buffer")]
pub(crate) type ArrayBufferIndex<'a> = BaseIndex<'a, ArrayBufferHeapData<'static>>;
pub(crate) type ArrayIndex<'a> = BaseIndex<'a, ArrayHeapData<'static>>;
pub(crate) type ArrayIteratorIndex<'a> = BaseIndex<'a, ArrayIteratorHeapData<'static>>;
pub(crate) type AsyncGeneratorIndex<'a> = BaseIndex<'a, AsyncGeneratorHeapData<'static>>;
pub(crate) type BigIntIndex<'a> = BaseIndex<'a, BigIntHeapData>;
pub(crate) type BoundFunctionIndex<'a> = BaseIndex<'a, BoundFunctionHeapData<'static>>;
pub(crate) type BuiltinFunctionIndex<'a> = BaseIndex<'a, BuiltinFunctionHeapData<'static>>;
pub(crate) type BuiltinConstructorIndex<'a> = BaseIndex<'a, BuiltinConstructorHeapData<'static>>;
#[cfg(feature = "array-buffer")]
pub(crate) type DataViewIndex<'a> = BaseIndex<'a, DataViewHeapData<'static>>;
#[cfg(feature = "date")]
pub(crate) type DateIndex<'a> = BaseIndex<'a, DateHeapData<'static>>;
pub(crate) type ECMAScriptFunctionIndex<'a> = BaseIndex<'a, ECMAScriptFunctionHeapData<'static>>;
...
pub(crate) type EmbedderObjectIndex<'a> = BaseIndex<'a, EmbedderObjectHeapData>;
pub(crate) type ErrorIndex<'a> = BaseIndex<'a, ErrorHeapData<'static>>;
pub(crate) type FinalizationRegistryIndex<'a> =
    BaseIndex<'a, FinalizationRegistryHeapData<'static>>;
pub(crate) type GeneratorIndex<'a> = BaseIndex<'a, GeneratorHeapData<'static>>;
pub(crate) type StringIteratorIndex<'a> = BaseIndex<'a, StringIteratorHeapData<'static>>;
pub(crate) type MapIndex<'a> = BaseIndex<'a, MapHeapData<'static>>;
pub(crate) type MapIteratorIndex<'a> = BaseIndex<'a, MapIteratorHeapData<'static>>;
pub(crate) type NumberIndex<'a> = BaseIndex<'a, NumberHeapData>;
pub(crate) type ObjectIndex<'a> = BaseIndex<'a, ObjectHeapData<'static>>;
pub(crate) type PrimitiveObjectIndex<'a> = BaseIndex<'a, PrimitiveObjectHeapData<'static>>;
pub(crate) type PromiseIndex<'a> = BaseIndex<'a, PromiseHeapData<'static>>;
pub(crate) type ProxyIndex<'a> = BaseIndex<'a, ProxyHeapData<'static>>;
#[cfg(feature = "regexp")]
pub(crate) type RegExpIndex<'a> = BaseIndex<'a, RegExpHeapData<'static>>;
#[cfg(feature = "set")]
pub(crate) type SetIndex<'a> = BaseIndex<'a, SetHeapData<'static>>;
#[cfg(feature = "set")]
pub(crate) type SetIteratorIndex<'a> = BaseIndex<'a, SetIteratorHeapData<'static>>;
#[cfg(feature = "shared-array-buffer")]
pub(crate) type SharedArrayBufferIndex<'a> = BaseIndex<'a, SharedArrayBufferHeapData<'static>>;
pub(crate) type StringIndex<'a> = BaseIndex<'a, StringHeapData>;
pub(crate) type SymbolIndex<'a> = BaseIndex<'a, SymbolHeapData<'static>>;
#[cfg(feature = "array-buffer")]
pub(crate) type TypedArrayIndex<'a> = BaseIndex<'a, TypedArrayHeapData<'static>>;
#[cfg(feature = "weak-refs")]
pub(crate) type WeakMapIndex<'a> = BaseIndex<'a, WeakMapHeapData<'static>>;
#[cfg(feature = "weak-refs")]
pub(crate) type WeakRefIndex<'a> = BaseIndex<'a, WeakRefHeapData<'static>>;
#[cfg(feature = "weak-refs")]
pub(crate) type WeakSetIndex<'a> = BaseIndex<'a, WeakSetHeapData<'static>>;
