...
pub fn initialize_date_heap(heap: &mut Heap) {
    ...
    let entries = vec![
        ...
        ObjectEntry::new_prototype_function_entry(heap, "getTimezoneOffset", 0, false, date_todo),
        ...
        ObjectEntry::new_prototype_function_entry(heap, "getUTCMilliseconds", 0, false, date_todo),
        ...
        ObjectEntry::new_prototype_function_entry(heap, "setUTCMilliseconds", 1, false, date_todo),
        ...
        ObjectEntry::new_prototype_function_entry(heap, "toLocaleDateString", 0, false, date_todo),
        ObjectEntry::new_prototype_function_entry(heap, "toLocaleString", 0, false, date_todo),
        ObjectEntry::new_prototype_function_entry(heap, "toLocaleTimeString", 0, false, date_todo),
