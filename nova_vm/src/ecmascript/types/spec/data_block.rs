...
impl DataBlock {
    ...
    pub fn create_byte_data_block<'gen>(agent: &mut Agent<'gen>, size: u64) -> JsResult<'gen, Self> {
    ...
    pub fn create_shared_byte_data_block<'gen>(agent: &mut Agent<'gen>, size: u64) -> JsResult<'gen, Self> {
