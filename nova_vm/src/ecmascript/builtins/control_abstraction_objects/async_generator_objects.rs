...
impl IntoObject for AsyncGenerator<'_> {
...
impl From<AsyncGenerator<'_>> for Object {
...
impl TryFrom<Object> for AsyncGenerator<'_> {
    type Error = ();
...
impl InternalSlots for AsyncGenerator<'_> {
...
impl InternalMethods for AsyncGenerator<'_> {}
