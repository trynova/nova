...
impl ObjectConstructor {
    ...
    fn assign(
        ...
        for next_source in sources {
            ...
            for next_key in keys {
                ...
                let desc = from.internal_get_own_property(
                    agent,
                    gc.reborrow(),
                    scope.reborrow(),
                    next_key,
    ...
    fn create(
        ...
        let obj: OrdinaryObject = if o == Value::Null {
            ...
            let error_message = format!(
                ...
                o.string_repr(agent, gc.reborrow(), scope.reborrow())
                    .as_str(agent)
            );
    ...
    fn entries(
        ...
        >(agent, gc.reborrow(), scope.reborrow(), obj)?;
    ...
    fn freeze(
        ...
        let status = set_integrity_level::<Frozen>(agent, gc.reborrow(), scope.reborrow(), o)?;
        if !status {
    ...
    fn from_entries(
        ...
        add_entries_from_iterable_from_entries(
            agent,
            gc.reborrow(),
            scope.reborrow(),
            obj,
    ...
    fn get_own_property_descriptor(
        ...
        let desc = obj.internal_get_own_property(agent, gc.reborrow(), scope.reborrow(), key)?;
    ...
    fn get_own_property_descriptors(
        ...
        let own_keys = obj.internal_own_property_keys(agent, gc.reborrow(), scope.reborrow())?;
        ...
        for key in own_keys {
            ...
            let desc =
                obj.internal_get_own_property(agent, gc.reborrow(), scope.reborrow(), key)?;
    ...
    fn get_own_property_names(
        ...
        let keys = get_own_string_property_keys(agent, gc.reborrow(), scope.reborrow(), o)?;
    ...
    fn get_prototype_of(
        ...
        obj.internal_get_prototype_of(agent, gc, scope)
    ...
    fn set_prototype_of(
        ...
        let status = o.internal_set_prototype_of(agent, gc.reborrow(), scope.reborrow(), proto)?;
...
fn object_define_properties<T: InternalMethods>(
    ...
    let keys = props.internal_own_property_keys(agent, gc.reborrow(), scope.reborrow())?;
    ...
    for next_key in keys {
        ...
        let prop_desc =
            props.internal_get_own_property(agent, gc.reborrow(), scope.reborrow(), next_key)?;
    ...
    loop {
        ...
        let Ok(next) = Object::try_from(next) else {
            ...
            let error_message = format!(
                ...
                next.string_repr(agent, gc.reborrow(), scope.reborrow())
                    .as_str(agent)
            );
...
fn get_own_string_property_keys(
    ...
    let keys = obj.internal_own_property_keys(agent, gc.reborrow(), scope.reborrow())?;
