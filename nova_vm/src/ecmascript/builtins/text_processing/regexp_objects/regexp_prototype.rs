...
struct RegExpPrototypeDotAll;
impl Builtin for RegExpPrototypeDotAll {
...
struct RegExpPrototypeIgnoreCase;
impl Builtin for RegExpPrototypeIgnoreCase {
...
struct RegExpPrototypeMultiline;
impl Builtin for RegExpPrototypeMultiline {
...
struct RegExpPrototypeSource;
impl Builtin for RegExpPrototypeSource {
...
struct RegExpPrototypeStricky;
impl Builtin for RegExpPrototypeStricky {
    const NAME: String = BUILTIN_STRING_MEMORY.get_stricky;
    const LENGTH: u8 = 0;
...
struct RegExpPrototypeUnicode;
impl Builtin for RegExpPrototypeUnicode {
...
struct RegExpPrototypeUnicodeSets;
impl Builtin for RegExpPrototypeUnicodeSets {
        ...
        OrdinaryObjectBuilder::new_intrinsic_object(agent, realm, this)
            ...
            .with_property(|builder| {
                builder
                    ...
                    .with_getter(|agent| {
                        BuiltinFunctionBuilder::new::<RegExpPrototypeDotAll>(agent, realm)
                            .build()
                            .into_function()
                    })
            ...
            .with_property(|builder| {
                builder
                    ...
                    .with_getter(|agent| {
                        BuiltinFunctionBuilder::new::<RegExpPrototypeFlags>(agent, realm)
                            .build()
                            .into_function()
                    })
                    .with_enumerable(false)
            ...
            .with_property(|builder| {
                builder
                    ...
                    .with_getter(|agent| {
                        BuiltinFunctionBuilder::new::<RegExpPrototypeGlobal>(agent, realm)
                            .build()
                            .into_function()
                    })
                    .with_enumerable(false)
            ...
            .with_property(|builder| {
                builder
                    ...
                    .with_getter(|agent| {
                        BuiltinFunctionBuilder::new::<RegExpPrototypeHasIndices>(agent, realm)
                            .build()
                            .into_function()
                    })
                    .with_enumerable(false)
            ...
            .with_property(|builder| {
                builder
                    ...
                    .with_getter(|agent| {
                        BuiltinFunctionBuilder::new::<RegExpPrototypeIgnoreCase>(agent, realm)
                            .build()
                            .into_function()
                    })
                    .with_enumerable(false)
            ...
            .with_property(|builder| {
                builder
                    ...
                    .with_getter(|agent| {
                        BuiltinFunctionBuilder::new::<RegExpPrototypeMultiline>(agent, realm)
                            .build()
                            .into_function()
                    })
                    .with_enumerable(false)
            ...
            .with_property(|builder| {
                builder
                    ...
                    .with_getter(|agent| {
                        BuiltinFunctionBuilder::new::<RegExpPrototypeSource>(agent, realm)
                            .build()
                            .into_function()
                    })
                    .with_enumerable(false)
            ...
            .with_property(|builder| {
                builder
                    .with_key(BUILTIN_STRING_MEMORY.stricky.into())
                    .with_getter(|agent| {
                        BuiltinFunctionBuilder::new::<RegExpPrototypeStricky>(agent, realm)
                            .build()
                            .into_function()
                    })
                    .with_enumerable(false)
            ...
            .with_property(|builder| {
                builder
                    ...
                    .with_getter(|agent| {
                        BuiltinFunctionBuilder::new::<RegExpPrototypeUnicode>(agent, realm)
                            .build()
                            .into_function()
                    })
                    .with_enumerable(false)
            ...
            .with_property(|builder| {
                builder
                    ...
                    .with_getter(|agent| {
                        BuiltinFunctionBuilder::new::<RegExpPrototypeUnicodeSets>(agent, realm)
                            .build()
                            .into_function()
                    })
                    .with_enumerable(false)
