...
impl Builtin for RegExpPrototypeGetHasIndices {
    ...
    const KEY: Option<PropertyKey<'static>> = Some(BUILTIN_STRING_MEMORY.hasIndices.to_property_key());
    const LENGTH: u8 = 0;
...
impl Builtin for RegExpPrototypeGetIgnoreCase {
    ...
    const KEY: Option<PropertyKey<'static>> = Some(BUILTIN_STRING_MEMORY.ignoreCase.to_property_key());
    const LENGTH: u8 = 0;
...
impl Builtin for RegExpPrototypeMatchAll {
    ...
    const KEY: Option<PropertyKey<'static>> = Some(WellKnownSymbolIndexes::MatchAll.to_property_key());
    const LENGTH: u8 = 1;
...
impl Builtin for RegExpPrototypeGetMultiline {
    ...
    const KEY: Option<PropertyKey<'static>> = Some(BUILTIN_STRING_MEMORY.multiline.to_property_key());
    const LENGTH: u8 = 0;
...
impl Builtin for RegExpPrototypeReplace {
    ...
    const KEY: Option<PropertyKey<'static>> = Some(WellKnownSymbolIndexes::Replace.to_property_key());
    const LENGTH: u8 = 2;
...
impl Builtin for RegExpPrototypeSearch {
    ...
    const KEY: Option<PropertyKey<'static>> = Some(WellKnownSymbolIndexes::Search.to_property_key());
    const LENGTH: u8 = 1;
...
impl Builtin for RegExpPrototypeGetUnicodeSets {
    ...
    const KEY: Option<PropertyKey<'static>> = Some(BUILTIN_STRING_MEMORY.unicodeSets.to_property_key());
    const LENGTH: u8 = 0;
...
impl RegExpPrototype {
    fn exec<'gen>(_agent: &mut Agent<'gen>, _this_value: Value<'gen>, _: ArgumentsList<'_, 'gen>) -> JsResult<'gen, Value<'gen>> {
        todo!()
    }

    fn get_dot_all<'gen>(_agent: &mut Agent<'gen>, _this_value: Value<'gen>, _: ArgumentsList<'_, 'gen>) -> JsResult<'gen, Value<'gen>> {
        todo!()
    }

    fn get_flags<'gen>(_agent: &mut Agent<'gen>, _this_value: Value<'gen>, _: ArgumentsList<'_, 'gen>) -> JsResult<'gen, Value<'gen>> {
        todo!()
    }

    fn get_global<'gen>(_agent: &mut Agent<'gen>, _this_value: Value<'gen>, _: ArgumentsList<'_, 'gen>) -> JsResult<'gen, Value<'gen>> {
        todo!()
    }

    fn get_has_indices<'gen>(
    ...
    fn get_multiline<'gen>(_agent: &mut Agent<'gen>, _this_value: Value<'gen>, _: ArgumentsList<'_, 'gen>) -> JsResult<'gen, Value<'gen>> {
        todo!()
    }
    ...
    fn get_source<'gen>(_agent: &mut Agent<'gen>, _this_value: Value<'gen>, _: ArgumentsList<'_, 'gen>) -> JsResult<'gen, Value<'gen>> {
        todo!()
    }
    ...
    fn get_sticky<'gen>(_agent: &mut Agent<'gen>, _this_value: Value<'gen>, _: ArgumentsList<'_, 'gen>) -> JsResult<'gen, Value<'gen>> {
        todo!()
    }

    fn test<'gen>(_agent: &mut Agent<'gen>, _this_value: Value<'gen>, _: ArgumentsList<'_, 'gen>) -> JsResult<'gen, Value<'gen>> {
        todo!()
    }
    ...
    fn get_unicode<'gen>(_agent: &mut Agent<'gen>, _this_value: Value<'gen>, _: ArgumentsList<'_, 'gen>) -> JsResult<'gen, Value<'gen>> {
        todo!()
    }

    fn get_unicode_sets<'gen>(
        _agent: &mut Agent<'gen>,
        _this_value: Value<'gen>,
        _: ArgumentsList<'_, 'gen>,
    ) -> JsResult<'gen, Value<'gen>> {
