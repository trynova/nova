...
impl<'gc> CreateHeapData<'gc, MapIteratorHeapData<'static>, MapIterator<'gc>> for Heap {
    fn create(&mut self, data: MapIteratorHeapData, gc: GcScope<'gc, '_>) -> MapIterator<'gc> {
