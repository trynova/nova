...
impl SetPrototype {
    ...
    fn add<'gen>(agent: &mut Agent<'gen>, this_value: Value<'gen>, arguments: ArgumentsList<'_, 'gen>) -> JsResult<'gen, Value<'gen>> {
...
#[inline(always)]
fn require_set_data_internal_slot<'gen>(agent: &mut Agent<'gen>, value: Value<'gen>) -> JsResult<'gen, Set> {
    match value {
