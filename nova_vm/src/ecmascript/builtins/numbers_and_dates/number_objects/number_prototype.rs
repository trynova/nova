...
impl NumberPrototype {
    fn to_exponential(
        ...
        let f = to_integer_or_infinity(agent, gc, scope, fraction_digits)?;
    ...
    fn to_locale_string(
        ...
        Self::to_string(agent, gc, scope, this_value, arguments)
    }
    ...
    fn to_precision(
        ...
        let p = to_integer_or_infinity(agent, gc, scope, precision)?;
