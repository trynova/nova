...
use super::{
    ...
    testing_and_comparison::{is_callable, is_constructor, require_object_coercible, same_value},
    type_conversion::{
...
pub(crate) fn species_constructor<'a>(
    ...
    Err(agent.throw_exception_with_static_message(ExceptionType::TypeError, "", gc.nogc()))
}
